                ...
                <div className="flex justify-between h-16">
                    <div className="flex items-center space-x-48 ml-4">
                        <h1 className="text-2xl font-bold text-white font-montserrat">
                            <img src="src\assets\b-shoelace.png" alt="logo" />
                        </h1>
                    ...
                    <div className="flex items-center space-x-4 px-12">
                        <p className="text-lg text-black font-montserrat"><TotalPrice /></p>
                        <p className="text-lg text-black font-montserrat">Berk</p>
                    </div>
                </div>
            </div>
        </nav>
